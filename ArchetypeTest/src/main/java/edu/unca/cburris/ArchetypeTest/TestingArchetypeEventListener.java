package edu.unca.cburris.ArchetypeTest;
...
public class TestingArchetypeEventListener implements Listener {

	private TestingArchetype plugin;

	public TestingArchetypeEventListener(TestingArchetype plugin) {
		this.plugin = plugin;
	}
